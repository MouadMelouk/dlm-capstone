...
if __name__ == "__main__":
    test_paths = [
        ["/scratch/rz2288/DeepfakeBench/datasets/rgb/Celeb-DF-v1/Celeb-real/frames/id9_0000/000.png"], ["/scratch/rz2288/DeepfakeBench/datasets/rgb/Celeb-DF-v1/Celeb-real/frames/id9_0000/014.png"]
    ]
    Results = run_inference_on_images_with_old_preprocess(
       ...
       #weights_path="/scratch/rz2288/DeepfakeBench/training/weights/spsl_best.pth",
        ...
        cuda=True,
        manual_seed=42,
        #running_inference = False # only false for spsl due to original code integrated label and accuracy calculation in spsl_detector class function
    )
