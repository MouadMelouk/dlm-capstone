...
class XceptionDetector(AbstractDetector):
    ...
    def generate_gradcam(self, input_image, target_class=None, image_path=None):    
        ...
        datasets_base_path = '/scratch/rz2288/DeepfakeBench/gradcam_output/test0208/'
        ...
        save_path = os.path.join(datasets_base_path, image_path)
    ...
    def build_backbone(self, config):
        ...
        state_dict = torch.load("./training/weights/xception_best.pth")
        #(config['pretrained'])
