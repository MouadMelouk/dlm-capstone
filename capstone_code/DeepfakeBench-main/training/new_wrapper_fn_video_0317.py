...
def run_inference_on_videos_with_old_preprocess(model_name,
        video_paths,
        cuda=True,
        manual_seed=42,
        frame_output_folder = "output_frames_0308_1", 
    ...
    frame_paths = process_videos(video_paths, frame_output_folder, num_frames)
...
if __name__ == "__main__":
    ...
    Results = run_inference_on_videos_with_old_preprocess(
        ...
        cuda=True,
        manual_seed=42,
        frame_output_folder = "output_frames_0317_1",  #folder for extracted frames
        num_frames=5
    )
